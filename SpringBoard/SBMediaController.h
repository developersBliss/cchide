...
@interface SBMediaController : NSObject {
    ...
    //trackDuration, artist, shuffleMode, repeatMode, isLastTrack, uniqueIdentifier, isMusicApp, artworkData, title, trackElapsedTime, isFirstTrack, timestamp, album, playbackRate,
